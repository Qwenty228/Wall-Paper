...
from utils.settings import HEIGHT, WIDTH

# I DID NOT MAKE THIS SHADER.
# credits: https://www.shadertoy.com/view/llXfRr
# fractal trees gif by https://www.shadertoy.com/user/macbooktall
...
void main()
{
	...
	f_color = vec4(1.-col.xyz,clamp(1.-col.w/MAXDIST, 0., 1.)) + vec4(texture(tex, uvs).rgb, 0.0);
}
'''

    def set_uniforms(self, program, **kwargs):
        program['iTime'] = kwargs['time']
        program['iResolution'] = kwargs['aspect_ratio']*WIDTH, HEIGHT
        program['MAXDIST']  = (WIDTH**2 + HEIGHT**2)**0.5
