...
class DoomFire:
    def __init__(self, app) -> None:
        self.app = app
        self.FIRE_WIDTH = self.app.screen.get_width()//(PIXEL_SIZE*FIRE_REPS)
        self.FIRE_HEIGHT = self.app.screen.get_height()//PIXEL_SIZE
        self.palettes = self.get_palette()
        self.fire_array = self.get_fire_array()
        self.fire_surf = pg.Surface(
            [PIXEL_SIZE*self.FIRE_WIDTH, self.app.screen.get_height()])
